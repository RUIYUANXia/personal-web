...
const ConfluenceIcon = ({ iconFill = colors.textTitleLight }: IconProps) => {
  return (
    <svg fill={iconFill} height="800px" width="800px" version="1.1" id="Icon" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24" enableBackground="new 0 0 24 24" xmlSpace="preserve">

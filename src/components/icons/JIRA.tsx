...
const JiraIcon = ({ iconFill = colors.textTitleLight }: JiraIconProps) => {
  return (
    <svg fill={iconFill} width="800px" height="800px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
      <title>jira</title>
